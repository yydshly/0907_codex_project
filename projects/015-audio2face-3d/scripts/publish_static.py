...
def main():
 ...
 directories=build_review('DIRECTORY-GUIDE.md','directories.html').replace('href="effects.html"','href="index.html"')
 (TARGET/'directories.html').write_text(directories,encoding='utf-8',newline='\n')
