...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function dl(e,t,n){let r=new Float32Array(Zc),i=new G(0,1,0);return new Yo({name:`SphericalGaussianBlur`,defines:{n:Zc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ml(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fl(){return new Yo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ml(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function pl(){return new Yo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ml(),fragmentShader:`
...
`)}var Bu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Vu(e,t){let n=Bu[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Hu=new G;function Uu(){return q.getLuminanceCoefficients(Hu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Hu.x.toFixed(4)}, ${Hu.y.toFixed(4)}, ${Hu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Mu(i,i.VERTEX_SHADER,y),S=Mu(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ru(i,x,`vertex`),n=Ru(i,S,`fragment`);V(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Pf.BlurDirectionX=new W(1,0),Pf.BlurDirectionY=new W(0,1);var Ff={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},If=class extends wf{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ko.clone(Ff.uniforms),this.material=new Xo({name:Ff.name,uniforms:this.uniforms,vertexShader:Ff.vertexShader,fragmentShader:Ff.fragmentShader}),this._fsQuad=new Df(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};export{u as $,W as $t,X as A,oa as At,ic as B,Yo as Bt,Ns as C,An as Ct,wa as D,Lo as Dt,Ze as E,Vi as Et,y as F,We as Ft,Ie as G,Ro as Gt,Br as H,Oi as Ht,Is as I,Ac as It,Ki as J,Zt as Jt,R as K,Xs as Kt,Io as L,r as Lt,Bn as M,Xa as Mt,zn as N,Ft as Nt,pn as O,Qs as Ot,jn as P,_s as Pt,d as Q,Er as Qt,oc as R,Ge as Rt,va as S,hs as St,tc as T,Js as Tt,Hr as U,Ci as Ut,Li as V,No as Vt,ss as W,jr as Wt,ia as X,zo as Xt,aa as Y,Ps as Yt,l as Z,Bo as Zt,i as _,Zo as _t,Of as a,Fe as at,q as b,c as bt,$d as c,Pt as ct,Oc as d,di as dt,G as en,Ke as et,wi as f,$r as ft,zr as g,Qo as gt,Tr as h,$o as ht,jf as i,I as it,v as j,Tc as jt,As as k,da as kt,nc as l,K as lt,_a as m,es as mt,Pf as n,ys as nn,rc as nt,uf as o,e as ot,nr as p,ts as pt,ea as q,t as qt,Mf as r,en as rn,Ts as rt,ol as s,Wr as st,If as t,Qt as tn,Ds as tt,bs as u,J as ut,Nc as v,a as vt,xr as w,$s as wt,Ta as x,s as xt,Y as y,o as yt,ki as z,Vn as zt};